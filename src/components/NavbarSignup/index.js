    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          ...
          <Button className="w-100 google-icon" onClick={handleAuth}>
            <img src="google-icon.png" />
            <h6>Login with Google</h6>
          </Button>
        </Modal.Body>
        <Modal.Footer className="login-modal-footer">
          <NavLink className="forgotPasswordText" to="/password-reset">
            Forgot Password?
          </NavLink>
          <Button disabled={loading} type="submit" onClick={handleSubmitLogin}>
            Submit
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      >
        ...
        <Modal.Footer className="signup-modal-footer">
          <Button disabled={loading} type="submit" onClick={handleSubmitSignup}>
            Submit
          </Button>
        </Modal.Footer>
      </Modal>
